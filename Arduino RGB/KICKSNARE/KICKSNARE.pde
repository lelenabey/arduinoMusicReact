...
{
  background(0);
  if ( beat.isKick() ) background(255,0,0);//kickSize = 32;
  if ( beat.isOnset(17) ) background(0,255,0);//snareSize = 32;
  if ( beat.isHat() ) background(0,0,255);//hatSize = 32;
//  textSize(kickSize);
//  text("LOW", width/4, height/2);
//  textSize(snareSize);
//  text("MID", width/2, height/2);
//  textSize(hatSize);
//  text("HIGH", 3*width/4, height/2);
